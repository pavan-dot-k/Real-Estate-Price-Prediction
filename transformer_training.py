...
feature_cols = ['year', 'month', 'zip', 'median_income', 'crime_rate_per_1000']
...
# Save scalers and training info
os.makedirs('models', exist_ok=True)
with open('models/transformer_scaler_X.pkl', 'wb') as f:
    pickle.dump(scaler_X, f)
with open('models/transformer_scaler_y.pkl', 'wb') as f:
...
with open('models/transformer_training_info.pkl', 'wb') as f:
    pickle.dump(training_info, f)

print("\nScalers and training info saved successfully!")
...
# Save the model
model.save('models/transformer_house_price_model.keras')
print("\nModel saved as 'models/transformer_house_price_model.keras'")

print("\n" + "="*60)
print("MODEL TRAINING COMPLETED SUCCESSFULLY!")
print("="*60)
print("\nFiles saved:")
print("  - models/transformer_house_price_model.keras")
print("  - models/transformer_scaler_X.pkl")
print("  - models/transformer_scaler_y.pkl")
print("  - models/transformer_training_info.pkl")
print("\nYou can now run transformer_prediction.py to make predictions!")
print("="*60)
